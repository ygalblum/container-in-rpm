...
install -m 644 mysql/* %{buildroot}%{_sysconfdir}/containers/systemd
...
%pre mysql-secrets
echo foo | podman secret create wrapme-mysql-root-password-container -

%postun mysql-secrets
podman secret rm wrapme-mysql-root-password-container
